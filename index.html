...
<html lang="en">
	...
	<body onload="init()">
		...
		<div class="container">
			...
			<div class="pengembang">Faizal</div>
		</div>
		...
		<script type="text/javascript">
			...
			function startTime() {
				...
				if (H<5){
					...
					txt='Good Afternoon, Get Some Rest';
					if(txt != txt2 && !starting)
						document.getElementById("quote").innerHTML = txt;
					txt2=txt;
				}
			...
			const quotes = [
			  ...
			  {
			    "quote": "Please dont leave me, Because I Love You",
			    "source": "Faizal"
			  },
			  {
			    "quote": "How are you?",
			  ...
			  {
			    "quote": "believe me, I only love you, nobody else",
			    "source": "Faizal"
			  },
			  {
			    "quote": "How's life?",
			  ...
			  {
			    "quote": "Jangan lupa bahagia!",
			    "source": "Faizal"
			  },
			  {
			    "quote": "Time Flies, but Memory Stays",
			    "source": "Faizal"
},
			]
